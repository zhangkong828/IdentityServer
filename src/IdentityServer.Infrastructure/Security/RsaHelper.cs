...
namespace IdentityServer.Infrastructure.Security
{
    public class RsaHelper
    {
        ...
        private static string RsaSign(string value, string key, Encoding encoding, RSAType type)
        {
            if (string.IsNullOrWhiteSpace(value) || string.IsNullOrWhiteSpace(key))
                return string.Empty;
            var rsa = new RsaHelper2(type, encoding, key);
    ...
    internal class RsaHelper2
    {
        ...
        public RsaHelper2(RSAType rsaType, Encoding encoding, string privateKey, string publicKey = null)
        {
            _encoding = encoding;
