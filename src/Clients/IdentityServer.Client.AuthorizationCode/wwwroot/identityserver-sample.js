...
var settings = {
    ...
    redirect_uri: url + '/identityserver-sample.html',
    post_logout_redirect_uri: url + '/identityserver-sample.html',
    response_type: 'id_token token',
    //response_mode:'fragment',
    scope: 'openid profile scope1 api1',
    
    popup_redirect_uri: url + '/identityserver-sample-popup-signin.html',
    popup_post_logout_redirect_uri: url + '/identityserver-sample-popup-signout.html',
    
    silent_redirect_uri: url + '/identityserver-sample-silent.html',
...
function startSigninMainWindowDiffCallbackPage() {
    mgr.signinRedirect({ state: 'some data', redirect_uri: 'http://localhost:8621/identityserver-sample-callback.html'}).then(function() {
        log("signinRedirect done");
    }).catch(function(err) {
        log(err);
    });
