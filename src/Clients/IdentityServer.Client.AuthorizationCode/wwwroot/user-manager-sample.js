...
var settings = {
    authority: 'http://localhost:40763',
    client_id: 'Test.Implicit',
    redirect_uri: 'http://localhost:8621/user-manager-sample.html',
    post_logout_redirect_uri: 'http://localhost:8621/user-manager-sample.html',
    response_type: 'id_token token',
    scope: 'openid email scope1 api1',
    
    popup_redirect_uri:'http://localhost:8621/user-manager-sample-popup-signin.html',
    popup_post_logout_redirect_uri:'http://localhost:8621/user-manager-sample-popup-signout.html',
    
    silent_redirect_uri:'http://localhost:8621/user-manager-sample-silent.html',
...
function startSigninMainWindowDiffCallbackPage() {
    mgr.signinRedirect({state:'some data', redirect_uri: 'http://localhost:8621/user-manager-sample-callback.html'}).then(function() {
        log("signinRedirect done");
    }).catch(function(err) {
        log(err);
    });
