using IdentityServer.IdentityServer4Extension.Interfaces;
...
namespace IdentityServer.IdentityServer4Extension.HostedServices
{
    public class TokenCleanup
    {
        ...
        public TokenCleanup(IPersistedGrants persistedGrants, ILogger<TokenCleanup> logger, IdentityServer4Options options)
        {
